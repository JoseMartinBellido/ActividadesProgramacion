...
/**
 * Clase constructora de un triángulo. Forma un triángulo a partir de sus 3 vértices.
 */
public class Triangulo implements Figura{
  ...
  @Override
  /**
   * Método que calcula si el triángulo es regular, es decir, si es equilátero.
   * @return true si es equilátero (3 lados iguales) o false si no lo es (isósceles o escaleno).
   */
  public boolean esRegular() {
    double lado1 = redondeaTresDecimales(calculaLado(vertice1, vertice2));
    double lado2 = redondeaTresDecimales(calculaLado(vertice2, vertice3));
    double lado3 = redondeaTresDecimales(calculaLado(vertice1, vertice3));
  ...
  private static double redondeaTresDecimales (double numero) {
    return Math.round(numero * 1000) / 1000.0;
  }
