...
public class Lavadora {
   ...
   * @param peso Peso de la lavadora en kilogramos (kg).
   ...
   * @param precioBase Precio base de la lavadora en euros (€).
   * @param color Color de la lavadora. Debe ser blanco, rojo, gris, negro o azul.
   * @param consumoEnergetico Consumo energético de la lavadora. Es una letra de la 'A' a la 'F'.
   * @param peso Peso de la lavadora en kilogramos (kg).
   * @param carga Carga de la lavadora en kilogramos (kg).
   * @throws IllegalArgumentException Si alguno de los parámetros no es válido.
   */
  ...
  private char compruebaConsumo (char consumoEnergetico) {
    ...
    if (consumoEnergetico < CONSUMO_A || consumoEnergetico > CONSUMO_F) {
      throw new IllegalArgumentException();
    } else
      return consumoEnergetico;
  }
